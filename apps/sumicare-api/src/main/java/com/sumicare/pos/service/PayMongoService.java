...
public class PayMongoService {
    ...
    public ChargeResult charge(Order order, BigDecimal amount, String paymentMethod, String referenceNumber) {
        ...
        if (appProperties.payment().paymongo().mockMode()) {
            ...
            return new ChargeResult(intentId, "succeeded");
        }
        ...
        String intentId = gateway.createIntent(amount, "PHP", metadata);
        return new ChargeResult(intentId, "succeeded");
    }

    public record ChargeResult(String intentId, String status) {}
}
