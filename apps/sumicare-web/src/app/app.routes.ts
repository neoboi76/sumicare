...
export const APP_ROUTES: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'verify', loadComponent: () => import('./features/auth/verify.component').then(m => m.VerifyComponent) },
      { path: 'reset-password', loadComponent: () => import('./features/auth/reset-password.component').then(m => m.ResetPasswordComponent) },
      { path: 'invite', loadComponent: () => import('./features/auth/invite.component').then(m => m.InviteComponent) },
      {
        path: 'app',
